...
"""
states = {'starting_state': 0, # [ [my_profile, list_movies(trending)], [list_movies(recommendation), watch_list] ]
		'my_profile': 1, # [ [typing(actor), typing(genre)], [rate_movie, starting_state] ]
		'list_movies': 2, # [ [watchlist_add], [starting_state] ]
		'typing': 3, # [ [typing(actor), typing(genre)], [starting_state] ]
		'watchlist_add': 4, # -> watchlist_choose [ [list_movies], [starting_state] ]
		'watchlist_choose':5 # -> watchlist_choose [ [list_movies], [starting_state] ]
		}
"""

states = {'select_action': 0,
		'add_actor': 1,
		'add_genre': 2,
		'profile_menu': 4,}
...
buttons = ['Add actor', 'Add genre', 'Trending movies', 
		...
		'My watch list', 'Manage my profile']
...
def start(update, context):
	...
	buttons = [[
		...
		InlineKeyboardButton(text=buttons[8], callback_data=str(states['profile_menu'])),
